  ...
  return (
    <div className="mb-3">
      ...
      <button
        ...
        className={cn(
          'flex items-center gap-2 text-[12px] font-medium px-3 py-1.5 rounded-lg transition-all duration-200 group',
      ...
      {expanded && (
        <div
          className={cn(
            'mt-1.5 ml-2 pl-3 border-l-2 text-[12.5px] leading-relaxed whitespace-pre-wrap text-muted-foreground',
...
export const ChatMessage: React.FC<ChatMessageProps> = ({ message }) => {
  ...
  const hasThinking =
    message.thinkingStartedAt !== undefined || message.thinkingTime !== undefined;
  ...
  return (
    ...
    >
      <div
        className={cn(
          'max-w-[85%] rounded-2xl px-5 py-3.5 mt-2 transition-all duration-200',
          isUser
